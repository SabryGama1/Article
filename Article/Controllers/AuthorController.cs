    ...
    public class AuthorController : Controller
    {
        ...
        public ActionResult Edit(int id, CoreView.AuthorView collection)
        {
            try
            {
                var author = new Author
                {
                    Id = collection.Id,
                    Bio = collection.Bio,
                    FaceBook = collection.Facbook,
                    FullName = collection.FullName,
                    Instagram = collection.Instagram,
                    Twitter = collection.Twitter,
                    UserId = collection.UserId,
                    UserName = collection.UserName,
                    ProfileImage = filesHelper.UploadFile(collection.ProfileImageUrl, "Images")
        ...
        public ActionResult Delete(int id, Author collection)
        {
            try
            {
                ...
                string filePath = "~/Images/" + collection.ProfileImage;
